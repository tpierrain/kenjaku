...
| `prospective/field-finding-2026-08-05-silent-skill-freeze.md` | An engine skill kept as "customized" on a deployed brain that had **zero lines of the owner's** in it, frozen since install day and never mentioned again. Persist the provenance base, teach the engine to recognise its own past output so frozen brains heal themselves, and make the freeze audible. | ahead of 3 | 🟢 **OPEN (2026-08-05)** — observed live on the mind-palace during the v4.7.0 → v4.8.0 update. Evidence is **measured** (brain git history + this repo's), written in the plan's § *What was measured*; do not re-derive it. **ALL THREE of its halves are being ANSWERED by the v5 chantier** — the persisted base by the archived `update-regime-owns-what-it-shipped-action.md` (S1-S6), *recognise its own past output so frozen brains heal themselves* as **S7**, and *make the freeze audible* as **S4-3/S4-4 then S10**, which goes past audible: since S10-3 (2026-08-21) a personalized file is named WITH the engine's version beside it and offered three choices, instead of merely being mentioned. **`prospective/v5-unfreezes-the-existing-fleet-action.md` owns the state of all three**; this row only points at it, and keeps no copy of what remains. |
