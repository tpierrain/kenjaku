...
- ✅ **[#78](https://github.com/tpierrain/kenjaku/issues/78) — DONE, both halves, 2026-09-12.** It was
  ...
  - 🪤 **What the exercise taught, and it is worth more than the fix.** The one-shot rewriter and the
    ...
    unterminated fence.
  - 🧬 **The §5quinquies mutation pass ran the same evening, and it earned its keep.** First pass
    **74.29 %**, 36 survivors _(log: `maintainers/mutation/reports/mutate-one-delivered-links.log`)_.
    Three were **branches no input can reach** and were deleted rather than tested; the largest cluster,
