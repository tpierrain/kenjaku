...
- Full suite green: **2 596 tests, 2 593 passing, 3 skipped, none failing**. Mutation is measured per block and scoped to the change, with every survivor either killed or documented as equivalent — figures in `maintainers/mutation/RESULTS.md`.
