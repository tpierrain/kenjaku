...
- ▶️ **STEP 8 — THE ANNOUNCEMENT BECOMES A QUESTION** _(opened 2026-09-04, the work resumes here; 6
  ...
  **✅ AND THIS PLAN IS NOW CLOSED — IT HOLDS NO LIVE STATE** _(2026-09-05)_. What the owner asked for
...
- [x] **8.10** _(2026-09-05)_ Then, and only then, the parent plan's 8.3 is unblocked and the release
      can be cut. **It is unblocked. Cutting it is the owner's, and only his.** ⚠️ **Held again the
      same morning**: he read the duo surface, asked what stops the NEWCOMER from being the one who
      says "it's fine", and four items answer it — in the plan named just below, not here.

### 9. What a duo owes the person whose brain it is → MOVED, and this is the pointer
