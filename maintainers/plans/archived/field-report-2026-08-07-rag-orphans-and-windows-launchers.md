...
>    Title arbitrated by Thomas: ***v4.8.1 — The One Where Closing It Actually Closes It***.
>    **Daniel MARTIN is thanked by name, above the fold** — Thomas asked for it explicitly; do not
>    demote it into the technical section. Archive the file to `archived/` when the release is cut.
