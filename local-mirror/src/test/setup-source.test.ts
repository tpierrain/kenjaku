...
// Universe-awareness (ADR 0034) — which universe a mirror is attached to, how it is chosen, and
// what stays invisible below the disclosure gate — lives in `setup-source-universe.test.ts`.
