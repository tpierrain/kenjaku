...
| **Evolution** | Update forced by the vendor | **Local iteration**: you add/modify your own skills, in your brain. Engine improvements reach you **only once you have said yes** — your brain will offer, at most once a day, and *"no thanks"* really does mean no — and **your words are never lost**: on a skill you tailored, what shipped since is merged *around* your edits, and where the two collide your version stands and you are offered three answers (take the new one, keep yours, combine them). Since v4.8.0 the offer **names the version and quotes what that release gives you**, so "yes" is an informed yes |
